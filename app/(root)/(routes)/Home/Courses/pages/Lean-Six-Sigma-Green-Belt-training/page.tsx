    ...
    <div className="w-full h-auto p-6">
      <div className="p-6">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-4xl font-extrabold">
              ...
              <p className="font-medium text-lg opacity-90">
                Elevate your career in Lean Six Sigma by achieving your Lean Six
                Sigma Green Belt certification. Acquire a deep understanding of
                the DMAIC methodology through practical case studies and develop
                the essential skills required to contribute to your
                organization's growth. Our online Lean Six Sigma Green Belt
        ...
        <div ref={sectionRef} className="flex ">
          ...
          >
            <SheduleForm title="Lean Six Sigma Green Belt training" duration="4 days" />
          </div>
        </div>
        <Contactus_card />
      </div>
