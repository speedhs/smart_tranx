...
const Keyfeatures = () => {
  const trainingOptions = [
    ...
    {
      title: "Certificate",
      description: "35 PDU's & course completion certificate",
      icon: "https://img.icons8.com/fluency/50/000000/certificate.png",
    },
    {
      title: "Exam",
      description: "Aligned with the global standards of the renowned Six Sigma Green Belt certification institutions ASQ and IASSC",
