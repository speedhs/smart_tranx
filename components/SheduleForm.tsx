...
const SheduleForm: React.FC<scheduleformProps> = ({ title, duration }) => {
  return (
    <div className="w-auto h-auto rounded px-4 py-2  justify-center  border-2 border-orange-500 max-w-[400px] bg-orange-50 flex flex-col min-w-72 p-7 right-2 top-13" >
